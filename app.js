...
var incompleteTaskHolder=document.querySelector(".check-items__list");//ul of #incompleteTasks
var completedTasksHolder=document.querySelector(".completed-items__list");//completed-tasks
