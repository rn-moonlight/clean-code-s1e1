...
let incompleteTaskHolder = document.querySelector(".check-items__list");//ul from check-items section
let completedTasksHolder = document.querySelector(".completed-items__list");//ul from completed-items section
...
let editTask = function() {
    ...
    //If class of the parent is .item-edit
    if (containsClass) {
        //switch to .item-edit
    ...
    //toggle .item-edit on the parent.
...
let taskCompleted = function() {
    ...
    //Append the task list item to the .completed-items__list
    let listItem = this.parentNode;
...
let taskIncomplete = function(){
    ...
    //Append the task list item to the .check-items__list
    let listItem = this.parentNode;
